####이 프로그램은 2016년 2학기 동의과학대학교 컴퓨터정보과 "공공데이터 Open API를 이용한 iOS  앱개발" 수업에 참여한 학생들에 의해 개발되었습니다. 개발환경은 iOS9/10,  Swift2/3 입니다. 시민들에게 지속적으로 사랑받는 생활 공공 모바일 앱이  많아 지기를 기원합니다. 특히 공공데이터 및 iOS 앱개발을 공부하는 학생들에게 도움 되기 바랍니다.
