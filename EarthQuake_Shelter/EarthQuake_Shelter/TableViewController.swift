...
class TableViewController: UITableViewController, MKMapViewDelegate {
    ...
    var selected = ShelterPoint.init(title: "", coordinate: CLLocationCoordinate2DMake(0, 0), subtitle: "", capacity: 0)
    
//    @IBAction func unwind(_ sender: UIBarButtonItem) {
//        unwind(for: segue, towardsViewController: segue.source as! ViewController)
...
//        if parent == nil {
//            parent?.title = "전국 지진 대피소"
//        }
//    }
    
    override func viewWillDisappear(_ animated: Bool) {
        segue.source.title = "전국 지진 대피소"
    ...
    override func viewDidLoad() {
        ...
        lblCapacity.text = "\(selected.capacity)"
